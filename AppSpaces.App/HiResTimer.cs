...
public class HiResTimer
{
	...
	public float Interval
	{
		...
		set
		{
			if (value < 0f || float.IsNaN(value))
				throw new ArgumentOutOfRangeException(nameof(value), value, "invalid Interval");
			interval = value;
		}
	}
	...
	public float IgnoreElapsedThreshold
	{
		...
		{
			if (value <= 0f || float.IsNaN(value))
				throw new ArgumentOutOfRangeException(nameof(value), value, "invalid IgnoreElapsedThreshold");
	...
	public HiResTimer(float interval)
	{
		if (interval < 0f || float.IsNaN(interval))
			throw new ArgumentOutOfRangeException(nameof(interval), interval, "invalid interval");
